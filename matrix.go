...
// TransformPointAffine transforms a point by this matrix, assuming it is an affine transform (bottom row is 0,0,0,1).
// This avoids calculating W and the division by W, which is faster.
